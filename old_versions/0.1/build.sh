...
time g++  -I./glad -I./stb -I./ -I./qlib -I$VULKAN_SDK/include -DSDL -DVULKAN -DDEBUG2 -g -DOS_LINUX play_nine.cpp -o build/play_nine -I/usr/include/SDL2 -L$VULKAN_SDK/lib -L/home/quinn/SteamSDK/redistributable_bin/linux64 -lSDL2 -lvulkan -lshaderc_combined -lspirv-cross-c-shared -D_REENTRANT
