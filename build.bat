...
cl %CF_DEFAULT% %CF_SDL% %CF_VULKAN% -DOS_WINDOWS -DSDL -DVULKAN -DDEBUG2 ../qlib/sdl_application.cpp /link %LF_DEFAULT% %LF_SDL% %LF_VULKAN% %LF_SHADERS% /out:play_nine.exe
