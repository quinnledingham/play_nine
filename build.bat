...
REM cl %CF_DEFAULT% %CF_SDL% %CF_VULKAN% -DOS_WINDOWS -DSDL -DVULKAN -DDEBUG ../qlib/sdl_application.cpp /link %LF_DEFAULT% %LF_SDL% %LF_VULKAN% %LF_SHADERS% /out:play_nine.exe
cl %CF_DEFAULT% %CF_SDL% %CF_OPENGL% %CF_VULKAN% -DOS_WINDOWS -DSDL -DOPENGL -DDEBUG ../glad/gl.c ../qlib/sdl_application.cpp /link %LF_DEFAULT% %LF_SDL% %LF_OPENGL% %LF_SHADERS% /out:play_nine.exe
